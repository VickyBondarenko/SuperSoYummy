    ...
    <div className=" min-h-screen flex flex-col justify-center text-center px-[35px] md:px-[131px] xl:px-[450px]  bg-welcome_mob md:bg-welcome_tab xl:bg-welcome bg-cover  bg-center">
      ...
      <div>
        ...
        <div className="flex justify-center gap-3 md:gap-[18px]">
          <a href="/register">
            <AsimetricRoundedBtn
              style="bg-accentMain border-transparent text-whiteText hover:bg-accentDark  focus:bg-accentDark"
              text="Registration"
            />
          </a>
          <a href="/login">
            <AsimetricRoundedBtn
              style="border-whiteText hover:border-accentMain text-whiteText hover:text-accentMain focus:border-accentMain focus:text-accentMain"
              text="Sign In"
            />
          </a>
        </div>
