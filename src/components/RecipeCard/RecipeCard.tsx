...
export const RecipeCard: React.FC<IRecipeInfo> = (props) => {
  ...
  return (
    <li className="relative overflow-hidden group">
      ...
      <div className="absolute translate-y-full flex justify-center items-center z-10 top-0 left-0 right-0  h-full  bg-overlayBackdrop rounded-lg p-5 font-main text-whiteText group-hover:translate-y-0 group-hover:opacity-100 transition duration-500 ease-in-out">
        <p>{description}</p>
